...
I found out that these light effects can be made possible with **Volumetric Raymarching**, a topic [I've covered in the past](/painting-with-math-a-gentle-study-of-raymarching/) but haven't found any practical application in my React Three Fiber work so far!
...
To work around those artifacts while reducing the performance impact of our raymarching loop, we can introduce some **blue noise dithering**. I briefly mentioned this technique in [my article on volumetric clouds](/real-time-cloudscapes-with-volumetric-raymarching/#performance-optimization). As you may have guessed, it is also applicable here!
...
<FootnotesList
  notes={[
    ...
    },
    {
      ...
      content: (
        <p>
          In the case of <a href="/caustics-in-webgl/">caustics</a>, we
