...
Last year, I gave myself the objective of [learning Next.js](https://blog.maximeheckel.com/learning-in-public/) as it was getting more and more popular among the people I followed on Twitter and was adopted by many companies as their main frontend framework. The focus of the Next.js team on **Developer eXperience (DX) and simplicity** was striking the first time I tried it, **especially compared to Gatsby** which, back then, powered this blog and started to feel very cumbersome at times.
...
I wrote extensively about my SEO-related mistakes and incidents in [SEO mistakes I've made and how I fixed them](https://blog.maximeheckel.com/seo-mistakes-i-have-made-and-how-i-fixed-them/) in case you want to read scary SEO stories 👻
...
I wrote about one of those performance issues: my overreliance on `iframes` for Twitter Embeds which I solved by [building my own "Static Tweet" component](https://blog.maximeheckel.com/static-tweets-with-mdx-nextjs/).
