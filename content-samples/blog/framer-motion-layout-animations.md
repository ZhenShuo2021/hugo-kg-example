...
Framer Motion has changed a lot since I last wrote about it. So much so that I recently got a bit lost trying to build a specific _layout animation_ and [my own blog post](/advanced-animation-patterns-with-framer-motion/) that actually looked into this specific type of animation was far from helpful 😅. Despite the updated section I added back in November, it still felt like I was not touching upon several points on this subject and that some of them were incomplete.
...
Don't worry I got your back! You can check out my [guide to creating animations that spark joy with Framer Motion](/guide-animations-spark-joy-framer-motion/) to get started.
