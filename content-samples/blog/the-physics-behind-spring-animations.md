...
I dedicated an entire blog post about [the math behind Cubic Béziers](/cubic-bezier-from-math-to-motion/) that contains slick visualizations that easily explain how the motion these complex formulas define is obtained!

**Want to learn more about Framer Motion?**

Checkout my blog post [Guide to creating animations that spark joy with Framer Motion](/guide-animations-spark-joy-framer-motion/)!
