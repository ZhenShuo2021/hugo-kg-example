...
It took me a while to find a use case for a serverless function, but I ended up finding one: **Generating screenshot from code snippets**. I wrote about it here in [this post](/creating-beautiful-screenshots-source-code-with-serverless-function).
...
I wrote [The little guide to CI/CD for frontend developers](/guide-to-cicd-for-frontend-developers/) that contains everything I've learned when it comes to testing, automation, better release processes, deployments and overall anything that makes a team work faster!
...
I dedicated an entire blog post for this one: [The physics behind spring animations](/the-physics-behind-spring-animations).
...
I wrote [Going native: SwiftUI from the perspective of a React developer](/swiftui-as-react-developer/) to analyze some of the common design patterns between SwiftUI and React. I also plan to write another article that will focus exclusively on state management patterns which also share quite a few things in common with React. I hope these post will help some React developers to feel more comfortable with SwiftUI.
