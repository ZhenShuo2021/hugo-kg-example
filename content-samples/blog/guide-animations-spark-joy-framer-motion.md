...
I used delays and repetitions to orchestrate some of the micro-animations you can see in my [Guide to CI/CD for frontend developers](/guide-to-cicd-for-frontend-developers/) which were the first fairly complex animated components I implemented.
...
- [The physics behind spring animations](/the-physics-behind-spring-animations/)
- [How to use Framer Motion with Emotion styled-components](/framer-motion-emotion/)
