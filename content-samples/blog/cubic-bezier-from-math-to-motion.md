...
If you want to learn more about easing functions and Framer Motion, I wrote a [guide to get started with Framer Motion](/guide-animations-spark-joy-framer-motion/) that showcases how to use them and also covers all the basics you need to build delightful transitions.
