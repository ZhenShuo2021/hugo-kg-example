...
When writing my **first Three.js scene from start to finish** in [Building a Vaporwave scene with Three.js](/vaporwave-3d-scene-with-threejs/), I felt an immense sense of achievement. However, all I really did in this project was glue a couple of PNGs and maps I drew on Figma onto a plane and make the scene move. I'm being hard on myself here, I know 😅. At that point, I barely scratched the surface of the possibilities of creative coding on the web.
