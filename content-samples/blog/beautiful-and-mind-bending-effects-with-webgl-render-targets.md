...
If you've read my article [Refraction, dispersion, and other shader light effects](/refraction-dispersion-and-other-shader-light-effects/#transparent-mesh-with-fbo) this is the technique I used to make a mesh _transparent_: **by mapping the scene surrounding the mesh onto it as a texture with screen coordinates**.
