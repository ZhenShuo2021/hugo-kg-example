...
1. [Install Hugo](https://gohugo.io/installation/) extended version, the minimum version is `v0.158.0`.
...
If you want a pre-configured site, you can clone the setup from our documentation:
