...
- ``: **Standard notation.**. The content inside is treated as raw HTML and is not parsed by the Markdown engine.
- ``: **Markdown notation.**. The content inside is sent back to the Markdown engine to be parsed into HTML.
